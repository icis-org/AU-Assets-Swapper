...
Use the **f7** and hover over game assets in game to know the type, asset name.

Use [AsstesStduioMod](https://github.com/aelurum/AssetStudioMod) mod to see or export vanilla texture and size.
